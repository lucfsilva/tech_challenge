...
# X_total = pd.concat([X_treino_balanceado, X_teste_escalonado], axis=0)
# y_total = pd.concat([y_treino_balanceado, y_teste], axis=0)
# dados = X_total.copy()
...
melhor_modelo = modelagem.avaliar(modelos, X_treino_escalonado, y_treino, X_teste_escalonado, y_teste)
# melhor_modelo = modelagem.avaliar(modelos, X_treino_balanceado, y_treino_balanceado, X_teste_escalonado, y_teste)
